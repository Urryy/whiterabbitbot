...
public class BotCommands
{
    ...
    public static string CheckWhiteCoinsCommand = "Проверяем колличество ваших WhiteCoin's🫰🏻";
    public static string CheckNFTCollectionCommand = "Проверяем вашу коллекцию NFT для начисления бонусных токенов.💫";
    public static string AgainCheckNftCollectionCommand = "Проверям колличество ваших NFT💫";
